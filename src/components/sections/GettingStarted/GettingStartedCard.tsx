...
export default function GettingStartedCard({ card }: Props) {
    ...
    return (
        <div className="aspect-square bg-white rounded-[1.4375rem] px-[0.9375rem] py-[1.875rem] flex flex-col items-start justify-start h-full overflow-hidden relative
         md:rounded-[1.25rem] md:py-[0.9375rem] md:px-[1.125rem]
         2xl:rounded-[2.5rem] 2xl:ps-[1.5625rem] 2xl:pe-[0.9375rem] 2xl:py-[1.5625rem] 3xl:py-[1.875rem] 3xl:ps-[1.875rem] 3xl:pe-[1.25rem]
        ">
            {/* Count */}
            ...
            2xl:tracking-[-0.06em]
              ${t('lang') === 'ru' ? "md:mb-[0.625rem] 2xl:text-[1.5rem] 2xl:leading-[1.1] 2xl:mb-[0.625rem] " : "2xl:text-[1.625rem] 3xl:text-[1.875rem] 2xl:leading-[1.1] 3xl:leading-[1] 2xl:mb-[0.9375rem]  "}`}>
