...
export default function GettingStarted() {
    ...
    const swiper = [cards[0], cards[1],cards[3],cards[4],cards[5],cards[2]];
    ...
    return (
        <section id="#how-to-start" className={`getting-started gsap-up my-container  
            ...
            <div className={`flex justify-between items-center
                ...
                `}>
                {/* Заголовок секции */}
                <h2 className={`leading-[1] tracking-[-0.03em] font-${font}
                2xl:leading-[0.88] 
                ${t('lang') === "ru" ? 
                    `mb-[1.25rem] text-[1.5625rem] 
                    xs:text-[1.5625rem] 
                    md:text-[1.5625rem] 
                    2xl:text-[2.5rem] 2xl:mb-[1.875rem] 2xl:tracking-[-0.05em] 
                    3xl:text-[3.4375rem] 3xl:mb-[2.5rem] ` 
                    : 
                    `mb-[1.25rem] text-[1.875rem] 
                    sm:text-[1.875rem] 
                    md:text-[1.875rem] 
                    2xl:text-[2.8125rem] 2xl:mb-[2.5rem] 2xl:tracking-[-0.05em] 
                    3xl:text-[3.4375rem] 3xl:mb-[2.5rem] `}              
                `}>{title}</h2>
            ...
            {/* DESKTOP / >=48rem */}
            <div className="hidden mdd:grid grid-cols-4 
            md:gap-[0.3125rem] 
            2xl:gap-[0.5rem]">
