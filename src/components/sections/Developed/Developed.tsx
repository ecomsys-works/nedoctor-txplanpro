...
export default function Developed() {
  ...
  return (
    <section className="my-container mb-[65px] sm:mb-[90px] mdd:mb-[60px] 2xl:mb-[190px]">
        ...
        <div className="relative bg-white p-[20px] md:p-[20px] 2xl:p-[30px] 3xl:p-[40px] rounded-[20px] 2xl:rounded-[60px] overflow-hidden p-6">
          ...
          <div className="relative md:mb-[50px] 2xl:mb-[70px]">
            <div className="flex flex-col absolute top-0 left-0 ">
              <h2 className={`mb-[15pxp] md:mb-[10px] 2xl:mb-[20px] 3xl:mb-[30px] pt-[5px] max-w-[250px] 
                text-[36px] md:text-[25px] 2xl:text-[45px] 3xl:text-[55px] text-black leading-[1]  2xl:leading-[0.88] 2xl:tracking-[-0.05em] 3xl:tracking-[-0.08em] font-${font}`}>
                {section.top.title}
              </h2>

              <p className="max-w-[288px] text-[25px] sm:text-[36px] md:text-[14px] 2xl:text-[18px] text-black leading-[1.3] tracking-[-0.04em]">
          ...
          <div className="grid md:grid-cols-3 3xl:grid-cols-4 gap-10">
            {section.bottom.map((card, i) => (
              ...
              >
                <span className="shrink-0 md:w-[10px] md:h-[10px] 2xl:w-[15px] 2xl:h-[15px] bg-red-500 rounded-full md:mt-1 2xl:mt-1.5"></span>
        ...
        <div className="bg-black sm:bg-transparent p-[3px] sm:p-0 rounded-[20px]">
          ...
          <div className="flex flex-col gap-[3px] sm:gap-[40px] mb-[3px] sm:mb-[80px]">
            {section.bottom.map((card, i) => (
              ...
              >
                <span className="shrink-0 w-[10px] h-[10px] smm:w-[15px] smm:h-[15px] bg-red-500 rounded-full mt-0.5"></span>
