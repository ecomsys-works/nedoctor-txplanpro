...
export default function Footer() {
    ...
    return (
        <footer>
            {/* ================= DESKTOP ================= */}
            <div className="my-container lg:py-[6px] 3xl:py-[40px]">
                <div className="hidden lg:block relative">
                    ...
                    <div className="flex justify-center">
                        <span className="font-bold text-[20px] font-micro ml-[10px]">{t("footer.logo")}</span>
                    </div>

                    {/* RIGHT */}
                    <div className="absolute right-0 bottom-0 text-right">
                        <a href="#" className="inline-block foo-underline text-black transition hover:scale-x-103 hover:translate-x-[3%] text-[18px] leading-[1.3] tracking-[-0.04em] font-normal ">
                            {t("footer.dev")}
                        </a>
